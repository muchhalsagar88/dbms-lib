...
public class LoginTest extends BaseTest {
	...
	private List<LoginDetails> _generateTestData() {
		...
		LoginDetails loginDetail = new LoginDetails("u1", "p123");
		loginDetail.setPatron(s1);
		logins.add(loginDetail);

		loginDetail = new LoginDetails("u2", "p123");
		logins.add(loginDetail);
		loginDetail.setPatron(s2);

		loginDetail = new LoginDetails("u3", "p123");
		loginDetail.setPatron(s3);
		logins.add(loginDetail);

		loginDetail = new LoginDetails("u4", "p123");
		logins.add(loginDetail);
